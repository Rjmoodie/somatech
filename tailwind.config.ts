  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'float': '0 12px 40px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(0, 0, 0, 0.1)',
      },
      animation: {
        // Fade animations
        "fade-in": "fadeIn 0.6s cubic-bezier(0.4, 0, 0.2, 1)",
        "fade-in-fast": "fadeIn 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
        "fade-in-slow": "fadeIn 1s cubic-bezier(0.4, 0, 0.2, 1)",
        
        // Slide animations
        "slide-up": "slideUp 0.6s cubic-bezier(0.4, 0, 0.2, 1)",
        "slide-up-fast": "slideUp 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
