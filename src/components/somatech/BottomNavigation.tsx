...
const BottomNavigation = ({ activeModule, onModuleChange }: BottomNavigationProps) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-t border-gray-200/50 dark:border-gray-700/50 md:hidden z-30">
      <div className="grid grid-cols-5 h-16">
        {quickModules.map((module) => (
          ...
          >
            ...
            {activeModule === module.id && (
              <div className="absolute bottom-0 w-8 h-1 bg-blue-500 rounded-full" />
            )}
          </button>
        ))}
      </div>
